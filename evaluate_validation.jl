...
begin
	...
	array_nr = 3
	mechanistic_parameters_val = CSV.read("$experiment_output_path/lv_missing_dynamics_lotka_volterra_datapoints_40_noise_5/no_sampling/par_1/183/mechanistic_parameters.csv", DataFrame)
	n_u1_val = parse(Float64,mechanistic_parameters_val[13,2])
	n_u2_val = parse(Float64,mechanistic_parameters_val[14,2])
	n_u3_val = parse(Float64,mechanistic_parameters_val[15,2])

	mechanistic_parameters_minl = CSV.read("$experiment_output_path/lv_missing_dynamics_lotka_volterra_datapoints_40_noise_5/no_sampling/par_1/807/mechanistic_parameters.csv", DataFrame)
	n_u1_minl = parse(Float64,mechanistic_parameters_minl[13,2])
	n_u2_minl = parse(Float64,mechanistic_parameters_minl[14,2])
	n_u3_minl = parse(Float64,mechanistic_parameters_minl[15,2])
...
begin
	mse_values=zeros(6,40)
	nmse_values=zeros(6,40)
	ngll_values=zeros(6,40)
	mse_values_807=zeros(6,40)
	nmse_values_807=zeros(6,40)
	ngll_values_807=zeros(6,40)
	for i in 1:6
	    for j in 1:40
	        mse_values_dummy, nmse_values_dummy, ngll_values_dummy, p_dum,pdum2,pdum3, skipped_mse_3_dummy_807, skipped_nmse_3_dummy_807, 		skipped_negll_3_dummy_807 = validationevaluation(i,j,n_u3_val,n_u3_minl)
	        mse_values[i,j]=mse_values_dummy[1]
	        nmse_values[i,j]=nmse_values_dummy[1]
	        ngll_values[i,j]=ngll_values_dummy[1]
			mse_values_807[i,j]=skipped_mse_3_dummy_807[1]
			nmse_values_807[i,j]=skipped_nmse_3_dummy_807[1]
			ngll_values_807[i,j]=skipped_negll_3_dummy_807[1]
	    end
	end
end
...
p_mse = heatmap(mse_values, title="MSE in dependence of skipped values", xlabel="time break", ylabel="skip step",  colorbar_title="MSE")

# ╔═╡ d6c93e76-930c-440a-8176-b4f240ed7a70
p_nmse = heatmap(nmse_values, title="nMSE in dependence of skipped values", xlabel="time break", ylabel="skip step",  colorbar_title="nMSE")

# ╔═╡ 44d1569f-4baa-478b-9cc5-80c3f59434a6
p_ngll = heatmap(ngll_values, title="NegLL in dependence of skipped values", xlabel="time break", ylabel="skip step",  colorbar_title="NegLL")

# ╔═╡ 9f6fa884-ec87-4adb-8ae4-22c606f69df5
begin
	md"""
	##### Experiment 807
	"""
...
# ╔═╡ a0909f2a-9cd8-4909-990e-eb40c1e9d8f4
p_mse_807 = heatmap(mse_values_807, title="MSE in dependence of skipped values", xlabel="time break", ylabel="skip step",  colorbar_title="MSE")

# ╔═╡ 25644804-1a59-44ea-83fd-6d5cad17d43c
p_nmse_807 = heatmap(nmse_values_807, title="nMSE in dependence of skipped values", xlabel="time break", ylabel="skip step",  colorbar_title="nMSE")
...
# ╔═╡ 760d0fca-6332-4b2d-b0cd-0d6fa12c29bf
begin
	md"nMSE"
end
...
@bind skip_step Slider(1:1:6, show_value=true)
...
# ╔═╡ 8110d14c-f13d-4cf6-963e-8556a2d790c4
@bind time Slider(t[1:end-1],show_value=true)

# ╔═╡ d3a68446-e343-49e1-963d-626906d067c5
time_break = Int(range(1,40,40)[findall(x->x==time,t)][1])

# ╔═╡ d29227d2-4e16-4f34-bc9d-cad845e9e23e
mse,nmse,ngll, p1,p2,p3,_ = validationevaluation(skip_step,time_break,n_u3_val,n_u3_minl)
...
# ╔═╡ ae594ef1-1b6e-4e31-a4bf-8fef1ace9624
p3
...
OptimizationOptimisers = "~0.1.5"
OrdinaryDiffEq = "~6.55.0"
Plots = "~1.39.0"
PlutoUI = "~0.7.52"
SciMLSensitivity = "~7.39.0"
Zygote = "~0.6.64"
"""
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "05ac9aedff4522a1e580d99a26aa7f2912bd0dda"
...
[[deps.Cassette]]
git-tree-sha1 = "415a5e8101d37582c0d912de8f7665b37e05ea5c"
...
deps = ["ArrayInterface", "ChainRulesCore", "ForwardDiff", "Functors", "LinearAlgebra", "PackageExtensionCompat", "StaticArrayInterface"]
git-tree-sha1 = "fb28e65c339c7fe2d6b4d1776c8c92dd5a828dce"
uuid = "b0b7db55-cfe3-40fc-9ded-d10e2dbeff66"
version = "0.14.1"
weakdeps = ["Adapt", "ConstructionBase", "GPUArrays", "RecursiveArrayTools", "ReverseDiff", "SciMLBase", "StaticArrays"]
...
git-tree-sha1 = "63d6d1114317b26d579baed45262273781400f3e"
...
git-tree-sha1 = "2a42e96bae10bc22e440b772075e9a45018d972d"
...
git-tree-sha1 = "fa967634d36f2a637a5655719cd02ca234a05a2c"
...
git-tree-sha1 = "a40975e29fb2a311f41f8541b12020f205e9e0e9"
