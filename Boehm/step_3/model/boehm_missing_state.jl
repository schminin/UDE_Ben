...
function ude_dynamics!(du, u, p, st_nn, t; augmented_dynamics=nn_model)
    ...
    #phys_3 = (BaF3_Epo * STAT5A * STAT5B * k_phos - 
    #    k_imp_hetero * pApB)
    ...
    # combined dynamics
    @inbounds du[1] = dphys_1
    @inbounds du[2] = dphys_2
    @inbounds du[3] = u_aug[1] 
    @inbounds du[4] = dphys_4
    @inbounds du[5] = dphys_5
    @inbounds du[6] = dphys_6
    @inbounds du[7] = dphys_7
    @inbounds du[8] = dphys_8
end;
